...
builder.Services.AddScoped<WhistleblowerPlatform.Client.Services.WhistleblowerService>();
builder.Services.AddScoped<WhistleblowerPlatform.Client.Services.AdminService>();
